  ...
  render () {
    ...
    return (
      <div sx={{pb: 3, borderRadius: '10px', margin: ['0 auto'], mb: 5, maxWidth: '3xl'}}>
        <Styled.h3 as='p' sx={{textAlign: 'center', mt: 0, color: 'accent'}}><GiAlarmClock sx={{variant: 'links.icon', fontSize: '4rem'}} /> Countdown to Camp {new Date().getFullYear()}</Styled.h3>
